  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="状态" prop="status">
        <el-select v-model="queryParams.status" placeholder="区域状态" clearable size="small" style="width: 120px">
    ...
    <el-table v-loading="loading" :data="areaList" :default-expand-all="isExpandAll" @selection-change="handleSelectionChange">
          <el-table-column type="selection" align="center" width="50" />
          <el-table-column label="区域编号" align="center" key="pkAreaId" prop="pkAreaId" v-if="columns[0].visible" />
          <el-table-column label="区域名称" align="center" key="areaName" prop="areaName" v-if="columns[1].visible" :show-overflow-tooltip="true" />
          <el-table-column label="区划代码" align="center" key="zoningCode" prop="zoningCode" v-if="columns[2].visible"/>
          <el-table-column label="所属城市" align="center" key="fkCityId" prop="fkCityId" v-if="columns[3].visible" :show-overflow-tooltip="true" />
          <el-table-column label="邮编" align="center" key="youbian" prop="youbian" v-if="columns[4].visible"/>
