<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="roleList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="角色编号" prop="pkRoleId" width="120" />
      <el-table-column label="角色名称" prop="roleName" :show-overflow-tooltip="true" width="150" />
      <el-table-column label="权限字符" prop="roleKey" :show-overflow-tooltip="true" width="150" />
      <el-table-column label="权限范围" prop="dataScope" width="100" />
      ...
      <!-- 操作栏  超级管理员不可操作，即pkRoleId=1-->
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope" v-if="scope.row.pkRoleId !== 1">
      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="权限范围" prop="dataScope">
          <el-radio-group v-model="form.dataScope">
            ...
            <el-radio :label="4">本部门及以下</el-radio>
          </el-radio-group>
        </el-form-item>
  ...
  methods: {
    ...
    getList () {
      ...
      listRole(this.addDateRange(this.queryParams, this.dateRange)).then(response => {
        this.roleList = response.rows.records;
    ...
    handleDataScope (row) {
      this.reset();
      const roleDeptTreeselect = this.getRoleDeptTreeselect(row.pkRoleId);
      getRole(row.pkRoleId).then(response => {
        this.form = response.data;
    ...
    handleAuthUser: function (row) {
      ...
      this.$router.push("/system/role/distribute/user/" + roleId);
    },
    /** 提交按钮 (基本信息)*/
    submitForm: function () {
